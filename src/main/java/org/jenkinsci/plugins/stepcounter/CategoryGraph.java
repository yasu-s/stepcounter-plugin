...
public class CategoryGraph extends Graph {

    private StepCounterResultAction obj;
    private String relPath;
    private Map<Integer, Color> _colors = new HashMap<Integer, Color>();

    public CategoryGraph(StepCounterResultAction obj, Calendar timestamp, int defaultW, int defaultH, String relPath) {
    ...
    protected JFreeChart createGraph() {
        ...
        final JFreeChart chart = ChartFactory.createLineChart(null, // chart
                // title
                null, // unused
                Messages.CategoryTrend_Label(), // range axis label
                dataset, // data
